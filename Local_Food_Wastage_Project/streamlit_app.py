...
# Set a page title for dashboard
...
# Base query
    ...
    params = []
    if sel_cities:
        base_sql += " AND p.City IN (" + ",".join(["%s"]*len(sel_cities)) + ")"
        params += sel_cities
    if sel_providers:
        base_sql += " AND p.Name IN (" + ",".join(["%s"]*len(sel_providers)) + ")"
        params += sel_providers
    if sel_food_types:
        base_sql += " AND f.Food_Type IN (" + ",".join(["%s"]*len(sel_food_types)) + ")"
